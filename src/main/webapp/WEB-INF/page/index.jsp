...
<head>
    ...
    <link rel="icon" href="${ctx}/static/custom/img/others/favicon.ico"/>
                    ...
                    <li data-name="app" class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd data-name="content">
                                ...
                                <dl class="layui-nav-child">
                                    <dd data-name="tags"><a lay-href="${ctx}/teacher/query">员工信息查询</a></dd>
                            ...
                            <dd data-name="forum">
                                ...
                                <dl class="layui-nav-child">
                                    <dd data-name="tags"><a lay-href="${ctx}/teacher/modify">员工信息修改</a></dd>
